...
public interface AdminDataManageMapper extends BaseMapper<AdminDataManage> {
    ...
    List<String>      uploadDataTable(MultipartFile file,String tableId, String pid, String tableName, String userName, String classPath, Integer uid, String tableStatus) throws IOException, ParseException;
